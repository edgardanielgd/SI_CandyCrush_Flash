package fl.motion
{
   ...
   public class MotionBase
   {
      ...
      {
         return Boolean(isNaN(param1)) || param1 < 0 || param1 > this.duration - 1;
      }
      
      public function getCurrentKeyframe(param1:int, param2:String = "") : KeyframeBase
      {
         var _loc4_:KeyframeBase = null;
         if(Boolean(isNaN(param1)) || param1 < 0 || param1 > this.duration - 1)
         {
            return null;
         }
      ...
      public function getValue(param1:Number, param2:String) : Number
      {
         ...
         if(Boolean(isNaN(_loc5_)) && _loc4_.index > 0)
         {
