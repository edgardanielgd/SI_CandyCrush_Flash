package fl.motion
{
   ...
   public class BezierSegment
   {
      ...
      public static function getCubicRoots(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0) : Array
      {
         ...
         var _loc8_:Number;
         if((_loc8_ = _loc6_ - _loc7_ * _loc7_) >= 0)
         {
            if(!_loc5_)
            {
               return [0];
         ...
         return [_loc16_ = -(_loc15_ = _loc7_ > 0 ? 1 : (_loc7_ < 0 ? -1 : 0)) * (_loc14_ + _loc5_ / _loc14_) - param2 / 3];
      }
      ...
      public static function getQuadraticRoots(param1:Number, param2:Number, param3:Number) : Array
      {
         ...
         var _loc6_:int;
         var _loc5_:Number;
         if((_loc6_ = (_loc5_ = param2 * param2 - 4 * param1 * param3) > 0 ? 1 : (_loc5_ < 0 ? -1 : 0)) < 0)
         {
            return [];
         }
         if(!_loc6_)
      ...
      public function getYForX(param1:Number, param2:Array = null) : Number
      {
         ...
         return Number(getSingleValue(_loc4_,this.a.y,this.b.y,this.c.y,this.d.y));
      }
   }
}
