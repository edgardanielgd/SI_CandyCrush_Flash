package fl.motion
{
   ...
   public class MatrixTransformer
   {
      ...
      public static function setScaleX(param1:Matrix, param2:Number) : void
      {
         ...
         var _loc3_:Number = Number(getScaleX(param1));
         if(_loc3_)
         {
         ...
         {
            _loc5_ = Number(getSkewYRadians(param1));
      ...
      public static function setScaleY(param1:Matrix, param2:Number) : void
      {
         var _loc4_:Number = NaN;
         var _loc5_:Number = NaN;
         var _loc3_:Number = Number(getScaleY(param1));
         if(_loc3_)
         {
            _loc4_ = param2 / _loc3_;
         ...
         {
            _loc5_ = Number(getSkewXRadians(param1));
      ...
      {
         var _loc3_:Number = Number(getRotationRadians(param1));
         var _loc4_:Number = Number(getSkewXRadians(param1));
